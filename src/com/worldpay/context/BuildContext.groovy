...
class BuildContext {
    ...
    static Map<String, BuildProfile> getGkopSupportedRegions() {
        ...
        "prod-eu-west-1", new BuildProfile("prod-euwest1", new GkopCluster("prod", "eu-west-1", "i8tjd", "api.eu-west-1-i8tjd.prod.msp.worldpay.io:443", "default-route-openshift-image-registry.apps.eu-west-1-i8tjd.prod.msp.worldpay.io")), "prod-us-east-1", new BuildProfile("prod-useast1", new GkopCluster("prod", "us-east-1", "ob4yk", "api.us-east-1-ob4yk.prod.msp.worldpay.io:443", "default-route-openshift-image-registry.apps.us-east-1-ob4yk.prod.msp.worldpay.io:443")),
