...
def call(Map parameters) {
    ...
    def CLUSTER_CREDENTIAL_ID = parameters.namespace as String
    def NAMESPACE = parameters.namespace as String
    def IGNORE_TLS = parameters.ignoreTls as Boolean
    def IS_RELEASE = parameters.isRelease as Boolean

    def kubernetesToken = kubernetesLogin(CLUSTER_USERNAME, CLUSTER_CREDENTIAL_ID, NAMESPACE, IGNORE_TLS)
