...
def call() {
    ...
    withCredentials([
        [$class: "AmazonWebServicesCredentialsBinding", accessKeyVariable: "AWS_ACCESS_KEY_ID", credentialsId: "${env.OWASP_DEPENDENCY_NVD_BUCKET_CREDENTIAL_ID}", secretKeyVariable: "AWS_SECRET_ACCESS_KEY"]
    ]) {
        sh """
